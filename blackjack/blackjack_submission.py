# -*- coding: utf-8 -*-
__author__ = 'clopez'
# http://www.codeskulptor.org/#user38_TwuHoP2kd2_2.py
...
class Hand:
    ...
    def get_value(self):
        ...
        """
        # FIXME: Aces counter is not really working.
        value = 0
        aces = 0
...
def deal():
    """
    If game is stopped, create and shuffle a new deck, deal two cards to player and dealer. Update gamenum.
    If game is running, player loses.
    Assign respective message to outcome, update in_play and score, calculate message's horizontal position.
    """
...
def hit():
    """
    If hand is in play, hit player. If busted, update outcome, update in_play and score, calculate horizontal position.
    """
...
def stand():
    ...
    Compare scores, assign message to outcome, update in_play and score, calculate horizontal position.
    """
    global in_play, outcome, score, xpos
